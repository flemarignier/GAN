...
from model import *
from util import *
from load_letters import letters_set
...
trX, vaX, teX, trY, vaY, teY = letters_set()
...
if not os.path.exists('vis_letters/'):
    os.makedirs('vis_letters/')
...
for epoch in range(n_epochs):
    ...
    for start, end in zip(
        ...
        if np.mod(iterations, step) == 0:
            ...
            save_visualization(generated_samples, (14,14), save_path='./vis_letters/sample_%04d.jpg' % int(iterations/step))
